...
Note: to access the web page use address:    http://x.x.x.x/ 
...
<br>  Enable/disable emails toggle with        http://x.x.x.x:6969/?email
<br>  Enable/disable sms toggle with           http://x.x.x.x:6969/?sms
<br>  Change 'first movement in' setting with  http://x.x.x.x:6969/?first=x
<br>  Change 'no movement in' setting with     http://x.x.x.x:6969/?none=x
<br>  Change movement detection timeframewith  http://x.x.x.x:6969/?timeframe=x
<br>  Change radar trigger level               http://x.x.x.x:6969/?trigger=x
<br>  Create test graph data with              http://x.x.x.x:6969/?testdata
<br>  Clear graph data with                    http://x.x.x.x:6969/?cleardata
<br>  Clear logs                               http://x.x.x.x:6969/?clearlog
<br>  Change high temp warning level           http://x.x.x.x:6969/?hightemp
<br>  Change low temp warning level            http://x.x.x.x:6969/?lowtemp
<br>  Load default settings                    http://x.x.x.x:6969/?defaults
